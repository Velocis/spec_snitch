...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Using only a GitHub API access token and the name of your repo, Snitch will create GitHub issues using the full descriptions of your pending specs.}
  spec.homepage      = ""
  spec.license       = "MIT"
